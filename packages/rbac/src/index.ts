...
export { Allow, AllowWithProvider, RolesProvider, useRoles } from "./client/index.js";
export type { useAllowedOptions, PermissionsContext, RolesData } from "./client/index.js";
