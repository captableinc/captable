    ...
    return (
      ...
      >
        ...
        <div className="relative mt-2">
          {open && (
            <CommandList className="no-scrollbar absolute top-0 z-10 w-full rounded-md border bg-popover text-popover-foreground shadow-md outline-none animate-in">
              {isLoading ? (
                <>{loadingIndicator}</>
              ) : (
                <>
